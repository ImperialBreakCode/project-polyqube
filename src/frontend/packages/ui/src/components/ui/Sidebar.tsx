	...
	return (
		<button
			...
			className={cn(
				...
				transition-all ease-linear after:absolute after:inset-y-0
				after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border
	...
	return (
		<Comp
			...
			className={cn(
				...
				ease-linear focus-visible:ring-2 [&>svg]:size-4
				[&>svg]:shrink-0`,
	...
	return (
		<Comp
			...
			className={cn(
				...
				overflow-hidden rounded-md px-2 text-sidebar-foreground
				outline-none ring-sidebar-ring hover:bg-sidebar-accent
