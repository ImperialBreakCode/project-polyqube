namespace API.Accounts.Common.Features.Users.Constants
{
    public static class UserValidationErrorMessages
    {
        ...
        public const string FIRST_LAST_NAMES_LENGTH_ERROR = "Names should be between 1 and 100 characters.";
        public const string FIRST_LAST_NAMES_ALLOWED_SYMBOLS_ERROR = "Names can only contain letters, dashes and apostrophes.";
    }
}
