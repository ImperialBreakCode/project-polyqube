...
{
    public class SendUserSoftDeletionFailedEmailConsumer : IConsumer<UserSoftDeletionFailedEvent>
    {
        ...
        public SendUserSoftDeletionFailedEmailConsumer(
        ...
        public async Task Consume(ConsumeContext<UserSoftDeletionFailedEvent> context)
        {
            var message = _mailMessageGenerator
                .GetUserDeletionFailedToStartMailMessage(_optionsMonitor.CurrentValue.SystemEmail);
